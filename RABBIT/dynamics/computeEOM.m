...
thisFile = mfilename('fullpath'); % Get the full path of the current script (computeEOM.m)
[thisFolder, ~, ~] = fileparts(thisFile);

targetFolder = fullfile(thisFolder, 'dynamics_AUTOgenerated'); % Create the full path to the target subfolder
...
matlabFunction(M_min, 'File', fullfile(targetFolder, 'M_minAUTO'), 'Vars', {x});
matlabFunction(c_min, 'File', fullfile(targetFolder, 'c_minAUTO'), 'Vars', {x,gamma});
matlabFunction(G_min, 'File', fullfile(targetFolder, 'G_minAUTO'), 'Vars', {x,gamma});

matlabFunction(dMdx, 'File', fullfile(targetFolder, 'dMdxAUTO'), 'Vars', {x});
matlabFunction(dW_swdx, 'File', fullfile(targetFolder, 'dW_swdxAUTO'), 'Vars', {x});
matlabFunction(dBTrafodx, 'File', fullfile(targetFolder, 'dBTrafodxAUTO'), 'Vars', {x});
matlabFunction(dM_mindx, 'File', fullfile(targetFolder, 'dM_mindxAUTO'), 'Vars', {x});
matlabFunction(dc_mindx, 'File', fullfile(targetFolder, 'dc_mindxAUTO'), 'Vars', {x,gamma});
matlabFunction(dG_mindx, 'File', fullfile(targetFolder, 'dG_mindxAUTO'), 'Vars', {x,gamma});
matlabFunction(dc_mindgamma, 'File', fullfile(targetFolder, 'dc_mindgammaAUTO'), 'Vars', {x,gamma});
matlabFunction(dG_mindgamma, 'File', fullfile(targetFolder, 'dG_mindgammaAUTO'), 'Vars', {x,gamma});
