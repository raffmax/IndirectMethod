...
matlabFunction(f, 'File', fullfile(targetFolder, 'fAUTO'), 'Vars', {x, u});
matlabFunction(dfdx, 'File', fullfile(targetFolder, 'f_xAUTO'), 'Vars', {x, u});
matlabFunction(dfdu, 'File', fullfile(targetFolder, 'f_uAUTO'), 'Vars', {x, u});
matlabFunction(g, 'File', fullfile(targetFolder, 'gAUTO'), 'Vars', {x});
matlabFunction(dgdx, 'File', fullfile(targetFolder, 'g_xAUTO'), 'Vars', {x});
